                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="/knowledgepage" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>知识库</p>
                                </a>
                            </li>
                        ...
                        <div class="modal-body">
                            <div class="modal-body-content">
                                <div class="form-group must">
                                    <label class="col-sm-3 control-label">名称</label>
                                    <div class="col-sm-7">
                                        <input type="text" class="form-control" id="editName" name="editName"></div>
                                </div>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-default" data-dismiss="modal">取消</button>
                            <button type="button" class="btn btn-primary" onclick="editButton()">保存</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    function isShow(fartherid,directory){
        $("#example1").css("display","block");
        $("#parentsId").val(fartherid);
